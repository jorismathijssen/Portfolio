...
export default function LanguageSwitcher(): React.JSX.Element | null {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-20 w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center focus:outline-hidden focus:ring-2 focus:ring-blue-500 font-bold text-lg tracking-wide transition-all duration-200 font-(family-name:--font-geist-sans) hover:bg-gray-200 dark:hover:bg-gray-700 shadow-md"
