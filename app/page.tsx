      ...
      <main id="main-content" className="max-w-3xl mx-auto" tabIndex={-1}>
        ...
        <section className="mb-12" aria-labelledby="about-heading">
          ...
          <p className="text-lg">
            ...
            <br />
            Employed by <a href="https://ict.eu" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">ICT Group</a> and seconded to <a href="https://9292.nl" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">9292</a>, enhancing the Netherlands&apos; leading transport platforms.
          </p>
        </section>
      </main>
    </div>
